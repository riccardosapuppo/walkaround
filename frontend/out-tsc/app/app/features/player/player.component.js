...
function PlayerComponent_section_0_section_14_ng_container_1_mat_slide_toggle_17_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "mat-slide-toggle", 22);
    i0.ɵɵlistener("ngModelChange", function PlayerComponent_section_0_section_14_ng_container_1_mat_slide_toggle_17_Template_mat_slide_toggle_ngModelChange_0_listener($event) { i0.ɵɵrestoreView(_r4); const ctx_r1 = i0.ɵɵnextContext(4); return i0.ɵɵresetView(ctx_r1.toggleOffline($event)); });
    i0.ɵɵtext(1);
    i0.ɵɵpipe(2, "t");
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function PlayerComponent_section_0_section_14_ng_container_1_p_18_Template(rf, ctx) { if (rf & 1) {
...
function PlayerComponent_section_0_section_14_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementContainerStart(0);
    i0.ɵɵelementStart(1, "input", 15);
    i0.ɵɵlistener("input", function PlayerComponent_section_0_section_14_ng_container_1_Template_input_input_1_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.seek($event)); });
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵlistener("click", function PlayerComponent_section_0_section_14_ng_container_1_Template_button_click_8_listener() { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.skip(-15)); });
    i0.ɵɵelementStart(9, "mat-icon", 6);
    i0.ɵɵtext(10, "replay_10");
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(11, "button", 19);
    i0.ɵɵlistener("click", function PlayerComponent_section_0_section_14_ng_container_1_Template_button_click_11_listener() { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.togglePlay()); });
    i0.ɵɵelementStart(12, "mat-icon", 6);
    i0.ɵɵtext(13);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(14, "button", 18);
    i0.ɵɵlistener("click", function PlayerComponent_section_0_section_14_ng_container_1_Template_button_click_14_listener() { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.skip(15)); });
    i0.ɵɵelementStart(15, "mat-icon", 6);
    i0.ɵɵtext(16, "forward_10");
    i0.ɵɵelementEnd()()();
    i0.ɵɵtemplate(17, PlayerComponent_section_0_section_14_ng_container_1_mat_slide_toggle_17_Template, 3, 4, "mat-slide-toggle", 20)(18, PlayerComponent_section_0_section_14_ng_container_1_p_18_Template, 3, 3, "p", 21);
    i0.ɵɵelementContainerEnd();
} if (rf & 2) {
    const state_r5 = ctx.ngIf;
    const currentPoi_r6 = i0.ɵɵnextContext(2).ngIf;
...
function PlayerComponent_section_0_section_14_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "section", 13);
    i0.ɵɵtemplate(1, PlayerComponent_section_0_section_14_ng_container_1_Template, 19, 7, "ng-container", 14);
    i0.ɵɵpipe(2, "async");
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function PlayerComponent_section_0_mat_card_15_Template(rf, ctx) { if (rf & 1) {
...
function PlayerComponent_section_0_p_16_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(ctx_r1.poiDescriptionLong(currentPoi_r6));
} }
function PlayerComponent_section_0_ng_template_17_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 25);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(ctx_r1.poiDescriptionShort(currentPoi_r6));
} }
function PlayerComponent_section_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(14, PlayerComponent_section_0_section_14_Template, 3, 3, "section", 10)(15, PlayerComponent_section_0_mat_card_15_Template, 4, 3, "mat-card", 11)(16, PlayerComponent_section_0_p_16_Template, 2, 1, "p", 12)(17, PlayerComponent_section_0_ng_template_17_Template, 2, 1, "ng-template", null, 0, i0.ɵɵtemplateRefExtractor);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const currentPoi_r6 = ctx.ngIf;
    const teaserDescription_r7 = i0.ɵɵreference(18);
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵattribute("aria-label", i0.ɵɵpipeBind1(2, 10, "common.goBack"));
    i0.ɵɵadvance(4);
    i0.ɵɵproperty("appImgFallback", currentPoi_r6.imageUrl)("alt", ctx_r1.poiName(currentPoi_r6));
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r1.poiName(currentPoi_r6));
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate2(" ", ctx_r1.audioUnavailable ? i0.ɵɵpipeBind1(10, 12, "player.audioUnavailable") : ctx_r1.previewMode ? i0.ɵɵpipeBind2(11, 14, "player.previewLabel", i0.ɵɵpureFunction1(21, _c0, ctx_r1.previewSeconds)) : i0.ɵɵpipeBind1(12, 17, "player.fullAudio"), " - ", i0.ɵɵpipeBind1(13, 19, currentPoi_r6.durationSec), " ");
    i0.ɵɵadvance(5);
...
function PlayerComponent_section_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementStart(0, "section", 28)(1, "mat-card", 24)(2, "p");
    i0.ɵɵtext(3);
    i0.ɵɵpipe(4, "t");
    i0.ɵɵpipe(5, "t");
    i0.ɵɵelementEnd();
...
export class PlayerComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PlayerComponent, selectors: [["app-player"]], standalone: false, decls: 3, vars: 3, consts: [["teaserDescription", ""], ["class", "player-page page-shell", 4, "ngIf"], ["class", "page-shell loading-shell", 4, "ngIf"], ["class", "page-shell player-page", 4, "ngIf"], [1, "player-page", "page-shell"], ["mat-icon-button", "", 1, "back", 3, "click"], ["fontSet", "material-icons-round"], [1, "hero-image", 3, "appImgFallback", "alt"], [1, "page-title"], [1, "page-subtitle"], ["class", "player card", 4, "ngIf"], ["class", "card warning", 4, "ngIf"], ["class", "description", 4, "ngIf", "ngIfElse"], [1, "player", "card"], [4, "ngIf"], ["type", "range", 1, "progress", 3, "input", "max", "value"], [1, "time-row"], [1, "controls"], ["mat-mini-fab", "", "color", "primary", 3, "click"], ["mat-fab", "", "color", "primary", 3, "click"], [3, "ngModel", "ngModelChange", 4, "ngIf"], ["class", "preview-note", 4, "ngIf"], [3, "ngModelChange", "ngModel"], [1, "preview-note"], [1, "card", "warning"], [1, "description"], [1, "page-shell", "loading-shell"], ["mode", "indeterminate", "diameter", "48"], [1, "page-shell", "player-page"], ["mat-stroked-button", "", "color", "primary", 3, "click"]], template: function PlayerComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵtemplate(0, PlayerComponent_section_0_Template, 19, 23, "section", 1)(1, PlayerComponent_section_1_Template, 5, 3, "section", 2)(2, PlayerComponent_section_2_Template, 9, 8, "section", 3);
        } if (rf & 2) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(PlayerComponent, { className: "PlayerComponent", filePath: "src/app/features/player/player.component.ts", lineNumber: 20 }); })();
