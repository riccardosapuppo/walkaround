...
function AdminDashboardComponent_div_3_ng_container_21_ng_container_50_tr_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate1(" ", payment_r9.type === "bundle" ? "Pacchetto citta" : "Luogo singolo", " ");
    i0.ɵɵadvance(2);
...
export class AdminDashboardComponent {
    ...
    deleteCatalogCity(city) {
        ...
        const confirmed = window.confirm(`Eliminare la citta "${city.name}"? Verranno eliminati anche i luoghi di interesse collegati.`);
        if (!confirmed) {
            return;
        }
