...
function resolveOfficialLogoPath() {
  ...
  const candidates = [
    ...
    path.resolve(__dirname, '../../../frontend/dist/walkaround-frontend/browser/assets/logo.png'),
    path.resolve(__dirname, '../../../frontend/dist/walkaround-frontend/assets/logo.png'),
    path.resolve(__dirname, '../../../public/assets/logo.png'),
