/**
 * Il catalogo di partenza: quattro citta' siciliane e 66 punti di interesse.
 *
 * OGNI `audioUrl` PUNTA ALLO STESSO FILE, ED E' UN SEGNAPOSTO CHE TACE. Gli
 * mp3 a pagamento non stanno in questo repository: sono il prodotto, e un
 * repository pubblico che li contiene e' il catalogo regalato. Prima queste
 * righe nominavano cinque tracce dimostrative — `catania/catania-guide.mp3` e
 * le altre quattro — che qui dentro non ci sono piu': cinque nomi senza file,
 * cioe' un 404 al primo clic su Catania, che e' anche la citta' predefinita.
 *
 * `public/audio/segnaposto.mp3` esiste per davvero, dura cinque secondi e non
 * dice niente; lo costruisce `scripts/genera-audio-segnaposto.js`, e li' c'e'
 * anche il perche' di ogni sua scelta. Serve a far funzionare la catena intera
 * su un'installazione nuova — anteprima gratuita, acquisto, riproduzione —
 * senza far finta che sia il prodotto: il prodotto si ascolta su
 * <https://walkaround.cloud>.
 *
 * `durationSec` invece resta quello delle tracce vere, e non e' una svista:
 * descrive il punto di interesse, non il file di ripiego, ed e' il numero che
 * il listino mostra e su cui l'anteprima calcola il proprio taglio.
 */
...
export const poisSeed = [
  {
    ...
    audioUrl: '/public/audio/segnaposto.mp3',
    priceSingle: 2.99,
    durationSec: 430
  },
  {
